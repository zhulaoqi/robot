...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='聊天记忆存储表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='知识库向量存储表';
...
VALUES ('计算机学院', '张教授', '010-12345678', 'cs@example.com'),
...
VALUES ('软工2021级1班', 1, 2021, '王老师'),
       ('中文2021级1班', 2, 2021, '赵老师');

-- 插入学生数据
INSERT INTO students (student_no, name, gender, birth_date, email, phone, enrollment_date, major_id, class_id, status)
VALUES ('2021001', '张铁牛', '男', '2003-05-15', 'zhang@example.com', '13800138001', '2021-09-01', 1, 1, '在读'),
...
VALUES ('T001', '陈教授', '男', '教授', 1, 'chen@example.com', '13900139001'),
